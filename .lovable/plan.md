...
*Goal: Project setup, design system, auth flows, and full database schema*
...
*Goal: Build the 7-level organizational hierarchy and full task CRUD*
...
## Phase 3: Dashboard
*Goal: Central hub showing daily overview, stats, active sessions, and goals*
...
*Goal: Full-featured study timer with Pomodoro mode and midnight handling*
...
*Goal: XP, levels, streaks, badges, and holidays to motivate study habits*
...
*Goal: Multi-view calendar with task scheduling, session blocks, and adherence tracking*
...
*Goal: Charts, backup/restore, offline sync, automation, testing, and final polish*
